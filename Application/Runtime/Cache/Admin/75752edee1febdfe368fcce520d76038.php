                        ...
                        <div class="you-z">
                            ...
                            <form>
                                ...
                                <div class="ron">
                                    <ul>
                                        <li>
                                            <div style="margin-bottom:40px" class="ron1">
                                                默认配送额: 
                                            </div>
                                            <span  class="nan1">每千米<input style="width:5% " type="text" class="okm" value="<?php echo ($result["lkmoney"]); ?>"/>元</span>
                                        </li>
                                        <li style="margin-top:10px">
                                            <span  class="nan">1.满<input style="width:5%" type="text" class="man" value="<?php echo ($result["maxprice"]); ?>"/>元 免配送费(当填写的值为-1的时候代表取消此项设定)</span>
                                        </li>
                                        <li style="margin-top:10px">
                                            <span  class="nan">2.<input style="width:5%" type="text" class="lkm" value="<?php echo ($result["maxlong"]); ?>"/>km 内送费费为<input style="width:5%" type="text" class="lmo" value="<?php echo ($result["maxmoney"]); ?>"/>元</span>
                                        </li>
                                        <li style="margin-top:10px">
                                            <span  class="nan">3.最低起送金额<input style="width:5%" type="text" class="lmoney" value="<?php echo ($result["lmoney"]); ?>"/>元</span>
                                        </li>
                                        <li style="margin-top:10px">
                                            <span  class="nan">4.最大配送距离<input style="width:5%" type="text" class="long" value="<?php echo ($result["long"]); ?>"/>元</span>
                                        </li>
                                    </ul>
                                    <div class="btn_part_one">
                                         <input type="button" value="保存" id="bao" class="btn_part"/>
                                    </div>
                                </div>
...
<script>
    $(function(){
        ...
        $('#bao').click(function(){
            var lkmoney = $('.okm').val();
            var maxprice = $('.man').val();
            var maxlong = $('.lkm').val();
            var maxmoney = $('.lmo').val();
            var lmoney = $('.lmoney').val();
            var long = $('.long').val();
            var shopid = $("input[type=hidden]").val();
            $.ajax({
                type:"POST",
                url:"<?php echo U('User/addpeisong');?>",
                data:{lkmoney:lkmoney,maxprice:maxprice,maxlong:maxlong,shopid:shopid,maxmoney:maxmoney,lmoney:lmoney,long:long},
                dataType:"json",
                success:function(data){
                    if(data.status == 1){
                        alert(data.msg);
