...
<!--                                <td width="60">
                            ...
                            <?php if(is_array($pingjia)): foreach($pingjia as $k=>$v): if($k%2 == 0): ?><tr class="ee1">
<!--                                <td width="60">
                                    <input type="checkbox" class="cen1">
                                </td>-->
                                <td width="80">
...
<script>
	$(function() {
            ...
            $(".delete").click(function(){
               ...
               var eid = $(this).parents("tr").find(".id").text();
                if(a == true){
                    $.ajax({
                    type: 'POST',
                    url: "<?php echo U('User/deletepingjia');?>",
                    data: {eid: eid},
                    dataType: "json",
                    success: function(data) {
                        if (data.status == 1) {
            ...
            $(".refresh").click(function(){
                ...
                var shopid = $("input[type=hidden]").val();
                var id = id * 1;
                window.location.href='/index.php/Admin/User/evaluateform?eid='+id+'&shopid='+shopid;
            })
            $('.outs').click(function(){
