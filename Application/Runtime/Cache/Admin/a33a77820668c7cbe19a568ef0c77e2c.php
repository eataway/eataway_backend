               ...
               <div class="rig-c2">
                   <ul>
                       ...
                       <li>
                           ...
                           <input name="oldpassword" type="password" class="rig-c3 old">
                       </li>
                       <li>
...
<script>
    $(function(){
        $('.oks').click(function(){
            ...
            $.ajax({
                type:"POST",
                url:"<?php echo U('Root/esit');?>",
                data:{uid:uid,name:name,news:news,pwd:pwd,old:old},
                dataType:"json",
                success:function(data){
                    if(data.status == 1){
                        ...
                        alert(data.msg);
                        window.location.href="<?php echo U('Login/loadlogin');?>";
                    }
                }
            });
