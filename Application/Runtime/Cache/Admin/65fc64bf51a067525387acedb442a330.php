                ...
                <div class="biao">
                    <div class="top">
                        <select  class="top1">
                                ...
                                <option id ="shangpu" <?php if($xs == 2): ?>selected = 'selected'<?php endif; ?> value="2">商铺反馈</option>
                        </select>
                         <div class="top2">
...
<!--                                <td>
                                ...
                                <td>
                                    <div class="cen4">
                                    <a href="/index.php/Admin/Shop/backdetailsp?id=<?php echo ($v["id"]); ?>&shopid=<?php echo ($v["shopid"]); ?>">
...
<!--                                <td>
                                ...
                                <td>
                                    <div class="cen4">
                                    <a href="/index.php/Admin/Shop/backdetailsp?id=<?php echo ($v["id"]); ?>&uid=<?php echo ($v["shopid"]); ?>">
                                        <input type="button" value="" class="refresh">
                                    </a>
                                    <input type="button" value="" class="delete">
                                    </div>
    ...
    $(function(){
        $(".delete").click(function(){
            ...
            if(a == true){
                $.ajax({
                    type:"POST",
                    url:"<?php echo U('Shop/deletemessage');?>",
                    data:{id:id},
                    dataType:"json",
        ...
        $('.sousuo').click(function(){
            ...
            if(shopname !== null){
                window.location.href='/index.php/Admin/Shop/backlistspw?shopname='+shopname;
            }
        })
        $('#kehu').click(function(){
            var v = $(this).val();
