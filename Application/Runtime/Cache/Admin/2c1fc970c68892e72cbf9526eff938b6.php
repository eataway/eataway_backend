...
<!--                                <td>
                            ...
                            <?php if(is_array($orderinfo)): foreach($orderinfo as $k=>$v): if($k%2 == 0): ?><tr class="ee1">
<!--                                <td>
                                    <input type="checkbox" class="cen1">
                                </td>-->
                                <td>
...
<script>
	$(function() {
            $(".delete").click(function(){
                 var a = confirm("确认删除吗？");
                var oid = $(this).parents("tr").find(".id").text();
                var orderid = oid *1;
                if(a == true){
                    $.ajax({
                    type: 'POST',
                    url: "<?php echo U('Shop/deleteorder');?>",
