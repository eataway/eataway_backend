...
//                $info[$k]['goods'] = $goodsinfo;
//            }
//            $infos = M('shopmessage')->field('maxmoney,shopname,shopphoto,mobile,content,shophead,state,detailed_address,coordinate,gotime,long,maxprice,maxlong,lkmoney')->where(['shopid' => $shopid])->find();
//            $infos['shophead'] = $this->path . $infos['shophead'];
//            $infos['shopphoto'] = $this->path . $infos['shopphoto'];
//            $coor = explode(",", $coor);
//            $coorend = explode(",", $infos['coordinate']);
